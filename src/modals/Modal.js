...
export default function Modal() {
    ...
    return (
        <>
            <div className="m-2 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-full my-2 mx-auto sm:w-[350px] md:w-[450px]">
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex items-center justify-end px-3 py-2 rounded-b">
                            <button className="text-white rounded bg-fix uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1"
                                type="button"
                                onClick={bclick}
                            >
                                Close
